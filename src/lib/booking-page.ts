...
const BOOKING_ENGINE_CSS_URL = "https://cdn.jsdelivr.net/gh/o7digital/villadelaroca@9f267cf/public/booking-engine.css";
...
function bookingCopy(locale: Locale) {
  if (locale === "es") {
    return {
      ...
      introTitle: "Una experiencia única en Zihuatanejo",
  ...
  return {
    ...
    introTitle: "A unique stay in Zihuatanejo",
      ...
      <section class="vdr-booking-body" id="availability">
        ...
        <section class="vdr-suite-gallery" data-gallery="suites" aria-labelledby="vdr-suite-gallery-title">
          <div class="vdr-suite-slider" data-gallery-slider>
            ...
            <button class="vdr-suite-slider__nav vdr-suite-slider__nav--prev" type="button" data-gallery-prev aria-label="${copy.previousPhoto}">‹</button>
            <button class="vdr-suite-slider__nav vdr-suite-slider__nav--next" type="button" data-gallery-next aria-label="${copy.nextPhoto}">›</button>
        ...
        <dialog class="vdr-suite-lightbox" data-suite-lightbox><button type="button" data-suite-close aria-label="${copy.close}">×</button><img data-suite-lightbox-image alt="" /></dialog>
    ...
    <script>
      (function () {
        ...
        function currentDates() {
          ...
          return {
            checkin: pageParams.get("checkin") || formatDate(checkinDate),
            checkout: pageParams.get("checkout") || formatDate(checkoutDate),
          };
        }
        ...
        function selectStay(stay, updateAddress) {
          ...
          frame.src = bookingUrl(propid, "iFrame", currentDates());
